package com.hist.weatherview.common.placeinfo.adapter;
...
public class PlaceInfoExpandableListViewAdapter extends BaseExpandableListAdapter{
    private List<String> cityList;
    private HashMap<String, List<String>> cityListDetail;
    private String[] keys;
    private Context context;

    public PlaceInfoExpandableListViewAdapter(Context context, List<String> cityList,
