 ...
 */
public class WeatherLifeAreaDataParser {
    ...
    private WeatherLifeAreaDataParserListener listener;


    public WeatherLifeAreaDataParser(Context mContext) {
        this.mContext = mContext;
        this.listener = (WeatherLifeAreaDataParserListener)mContext;
    }
